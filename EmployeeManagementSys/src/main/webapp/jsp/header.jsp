...
<body>
	...
	%>
	<ul>
		<li><a class="active" href="<%=CBEView.HOME%>"><i class="fa fa-home" aria-hidden="true"></i>Home</a></li>
		<li><a href="<%=CBEView.EMP_LOGIN%>"><i class="fa fa-sign-in" aria-hidden="true"></i>Login</a></li>
		<li><a href="<%=CBEView.ADD_EMP%>"><i class="fa fa-user" aria-hidden="true"></i>Register</a></li>
